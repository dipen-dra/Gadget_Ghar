        ...
        <div className="space-y-6">
            <div className="bg-white p-4 rounded-lg shadow-sm flex justify-center">
                <div className="relative w-full max-w-md">
                    ...
                    <input type="text" placeholder="Search this category..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="w-full pl-10 pr-4 py-2 border rounded-full bg-gray-50 focus:bg-white focus:ring-2 focus:ring-sky-500" />
                </div>
            </div>
            ...
            {filteredProducts && filteredProducts.length === 0 ? (
                ...
                <>
                    ...
                    <div className="text-center mt-8 flex justify-center items-center gap-4">
                        ...
                        {filteredProducts.length > visibleCount && <button onClick={handleLoadMore} className="bg-sky-600 text-white font-bold py-3 px-8 rounded-full hover:bg-sky-700">Load More</button>}
                    </div>
                </>
            )}
        </div>
